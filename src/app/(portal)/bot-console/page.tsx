...
export default function BotConsolePage() {
  ...
  return (
    <div className='container mx-auto p-6'>
      <div className='mb-8'>
        <h1 className='mb-2 text-3xl font-bold'>Bot Command Center</h1>
      ...
      {selectedBot && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Detailed bot information and controls
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue='overview'>
              ...
              <TabsContent value='settings' className='space-y-4'>
                <div>
                  <h3 className='mb-2 font-semibold'>Delegation Mode</h3>
                  <div className='flex gap-2'>
                    <Button
                      variant={
                        selectedBot.mode === 'shadow' ? 'default' : 'outline'
                      }
                    ...
                    <Button
                      variant={
                        selectedBot.mode === 'delegate' ? 'default' : 'outline'
                      }
                    ...
                    <Button
                      variant={
                        selectedBot.mode === 'autonomous'
                          ? 'default'
                          : 'outline'
                      }
                      onClick={() =>
                        updateBotMode(selectedBot.id, 'autonomous')
                      }
                    >
                      Autonomous
                    </Button>
...
function ModeBadge({ mode }: { mode: string }) {
  ...
  return (
    <Badge className={variants[mode as keyof typeof variants]}>{mode}</Badge>
  );
}
