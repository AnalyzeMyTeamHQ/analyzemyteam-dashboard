...
export const metadata = {
  ...
  description:
    'Video-to-data conversion with advanced computer vision processing'
};
    ...
    <div className='space-y-6 p-6'>
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='mt-2 text-muted-foreground'>
            Advanced video-to-data conversion with computer vision and AI
            processing
          </p>
        </div>
      ...
      <Card className='border-purple-500/20'>
        ...
        <CardContent className='space-y-4'>
          <p className='text-sm text-muted-foreground'>
            The Dynamic Fabricator uses advanced computer vision algorithms
            (OpenCV, YOLO, InsightFace) to automatically convert football game
            film into structured data. Extract player positions, formation
            classifications, and play outcomes directly from video.
          </p>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              What to expect when module launches
            </CardDescription>
          </CardHeader>
          <CardContent className='space-y-2'>
            <div className='flex items-center gap-3 p-2'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>
                  Triangle Defense classification from video
                </p>
              </div>
            </div>
            <div className='flex items-center gap-3 p-2'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>
                  22 player position extraction per frame
                </p>
              </div>
            </div>
            <div className='flex items-center gap-3 p-2'>
            ...
            <div className='flex items-center gap-3 p-2'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>
                  Sub-second video analysis with GPU acceleration
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How Dynamic Fabricator connects with other modules
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-3'>
          <div className='flex items-center justify-between rounded-lg bg-accent/50 p-3'>
            <div className='flex items-center gap-3'>
              <div className='flex h-10 w-10 items-center justify-center rounded-lg bg-amt-red/10'>
                <Video className='h-5 w-5 text-amt-red' />
              </div>
              <div>
                <p className='font-medium'>Power Playbooks</p>
                <p className='text-xs text-muted-foreground'>
                  Auto-generate playbooks from video analysis
                </p>
              </div>
            </div>
          ...
          <div className='flex items-center justify-between rounded-lg bg-accent/50 p-3'>
            <div className='flex items-center gap-3'>
              <div className='flex h-10 w-10 items-center justify-center rounded-lg bg-amt-accent/10'>
                <Cpu className='h-5 w-5 text-amt-accent' />
              </div>
              <div>
                <p className='font-medium'>M.E.L. AI</p>
                <p className='text-xs text-muted-foreground'>
                  AI analysis of extracted formations
                </p>
              </div>
            </div>
            <Badge variant='outline'>Connected</Badge>
          ...
          <div className='space-y-4 text-center'>
            ...
            <div>
              ...
              <p className='mx-auto mt-2 max-w-md text-sm text-muted-foreground'>
                The Dynamic Fabricator is currently under development. Expected
                launch in Q2 2025. Contact the development team for early access
                or feature requests.
              </p>
            </div>
